...
import 'package:movie_app/features/movie/presentation/widgets/expandable_text.dart';
      ...
      return Column(
        children: <Widget>[
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Expanded(child: Text('User Reviews', style: TextStyle(fontSize: 18))),
                GestureDetector(
                        ...
                        Row(
                          children: <Widget>[
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(height: 5),
                                      Text(reviewDetails[0]['creationDate'], style: TextStyle(fontSize: 12)),
                                    ],
                                  ),
                                ],
                              ),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: <Widget>[
                                FittedBox(fit: BoxFit.scaleDown, child: Icon(Icons.star, color: Colors.amber, size: 20)),
